...
@interface DrawbackViewController ()<UITableViewDelegate, UITableViewDataSource>
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section {
    ...
    pay.tag = section;
    [pay addTarget:self action:@selector(orderButtonTouch:) forControlEvents:UIControlEventTouchUpInside];
...
- (void)orderButtonTouch:(UIButton *)sender {
