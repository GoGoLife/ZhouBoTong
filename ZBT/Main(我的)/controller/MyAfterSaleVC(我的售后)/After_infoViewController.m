...
@interface After_infoViewController ()
...
@implementation After_infoViewController
...
- (void)viewDidLoad {
    ...
    [self.firstV mas_makeConstraints:^(MASConstraintMaker *make) {
...
//    leftImageV.image = [UIImage imageNamed:@"public"];
    ...
    label3.text = [NSString stringWithFormat:@"联系人：%@", self.dataDic[@"yuyue_name"]];//@"联系人：小明";
    
    //联系电话
    UILabel *label4 = [[UILabel alloc] init];
    label4.text = [NSString stringWithFormat:@"联系电话：%@", self.dataDic[@"phone"]];//@"联系电话：18268865135";
...
- (void)getInfo_Yuyue {
    ...
    [manager POST:url parameters:parme progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        ...
        [weakSelf setFirstView:weakSelf.firstV];
        [self setSecondView:self.secondV];
