//
//  After_WaitFinishViewController.m
//  ZBT
//
...
@interface After_WaitFinishViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation After_WaitFinishViewController
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
    [self.datatAry removeObjectAtIndex:indexPath.section];
    [self.tableView reloadData];
