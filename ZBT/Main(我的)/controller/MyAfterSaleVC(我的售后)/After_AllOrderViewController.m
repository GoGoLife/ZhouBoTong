//
//  After_AllOrderViewController.m
//  ZBT
//
...
@interface After_AllOrderViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation After_AllOrderViewController
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    label.text = [NSString stringWithFormat:@"售后编号：%@", self.datatAry[section][@"yuyue_number"]];
...
- (void)setCellContent:(MineTableViewCell *)cell AtIndexPaht:(NSIndexPath *)indexPath {
    ...
    cell.topTextF.text = isNullClass(dic[@"service_name"]);//@"XX冲锋艇";
    ...
    cell.bottomTextF.text = isNullClass(dic[@"appointment_time"]);//@"2018-10-10 13:00";
    [cell.bottomTextF creatRightView:FRAME(0, 0, [self calculateRowWidth:isNullClass(dic[@"merchant_name"]) withFont:13], height) AndTitle:isNullClass(dic[@"merchant_name"]) TextAligment:NSTextAlignmentLeft Font:SetFont(13) Color:[UIColor blackColor]];
}
StringWidth();
